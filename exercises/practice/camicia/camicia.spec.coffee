...
describe 'Camicia', =>
  ...
  xit 'the story is starting to get a bit complicated', =>
    playerA = [
      ...
      'A', 'J', 'J', '6', '2', 'J', '3', 'K', '2', '5', '9'
      'J', '9', '6', 'K', 'A', '5', 'Q', 'J', '2', 'Q', 'K'
      'A', '3', 'K', 'J', 'K', '2', '5', '6', 'Q', 'J', 'Q'
      'Q', 'J', '2', 'J', '9', 'Q', '7', '7', 'A', 'Q', '7'
      'Q', 'J', 'K', 'J', 'A', '7', '7', '8', 'Q', '10', 'J'
      '10', 'J', 'J', '9', '2', 'A', '2'
    ]
    playerB = [
      ...
      '10', 'A', 'Q', 'J', '6', 'J', 'A', '10', 'A', '5', '8'
      '3', 'K', '5', '9', 'Q', '8', '7', '7', 'J', '7', 'Q'
      'Q', 'Q', 'A', '7', '8', '9', 'A', 'Q', 'A', 'K', '8'
      'A', 'A', 'J', '8', '4', '8', 'K', 'J', 'A', '10', 'Q'
      '8', 'J', '8', '6', '10', 'Q', 'J', 'J', 'A', 'A', 'J'
      '5', 'Q', '6', 'J', 'K', 'Q', '8', 'K', '4', 'Q', 'Q'
      '6', 'J', 'K', '4', '7', 'J', 'J', '9', '9', 'A', 'Q'
      'Q', 'K', 'A', '6', '5', 'K'
    ]
    results = Camicia.simulateGame playerA, playerB
  ...
  xit 'Casella 2024, first infinite game found', =>
    ...
    results = Camicia.simulateGame playerA, playerB
    expect(results).toEqual {status: 'loop', cards: 474, tricks: 66}